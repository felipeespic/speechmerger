...
if __name__ == '__main__':
    ...
    for nx_f in xrange(nfrmnts):
        ...
        v_map_a_to_b_ord_gain[nx_f] = v_frmnts_bins_ord_gain_b_dyn[nx_chosen_b_frmnt]
    ...
    #v_frmnts_bins_ord_bins_b = v_frmnts_bins_ord_gain_b[v_order_bins_a]
    v_map_a_to_b_ord_bins    = v_map_a_to_b_ord_gain[v_order_bins_a]
